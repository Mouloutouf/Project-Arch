...
#pragma region Core Methods
        ...
        {
            GameObject newGameObject = GameObject(_name, _transform, _parent, _layer, _tags);
        ...
        GameObject* Scene::InstantiateGameObject(GameObject* _gameObject)
        {
            gameObjects.push_back(*_gameObject);

            mainCamera = GetMainCamera(); // Same, should find another solution
...
#pragma region Initialization
        ...
        inline void Scene::UserInit()
        {
            ...
            /*CreateSpriteObject("Fire Orb", ASSETS_FOLDER + "Fire Orb.png", 24, Vector2f(-2.5, 0.5));
            CreateSpriteObject("Robot", ASSETS_FOLDER + "Kastelan Robot.png", 24, Vector2f(3, 1));
            CreateSpriteObject("Dummy", ASSETS_FOLDER + "Dummy Sized.png", 24, Vector2f(-1.5, -0.5));*/

            GameObject* gridObject = CreateGameObject("Grid");
            gridObject->AddComponent(new Grid(20, 20));
        }
        void Scene::Start()
        {
